odoo.define('queue_line_ec.dashboard', function (require) {
    "use strict";
...
var QueueLineListDashboardRenderer = ListRenderer.extend({
    ...
    _renderView: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            var purchase_dashboard = QWeb.render('queue_line_ec.Dashboard', {
...
view_registry.add('queue_line_ec_dashboard', QueueLineListDashboardView);
