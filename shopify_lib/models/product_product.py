...
class ProductProduct(models.Model):
    ...
    def get_products_based_on_movement_date_ec(self, from_datetime, company):
        ...
        result = []
        mrp_module = self.search_installed_module_ec('mrp')
    ...
    def search_installed_module_ec(self, module_name):
    ...
    def get_free_qty_ec(self, warehouse, product_list):
    ...
    def get_forecasted_qty_ec(self, warehouse, product_list):
    ...
    def get_onhand_qty_ec(self, warehouse, product_list):
        """
