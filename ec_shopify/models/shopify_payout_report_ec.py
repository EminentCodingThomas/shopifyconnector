...
class ShopifyPaymentReportEpt(models.Model):
    ...
    def get_payout_report(self, start_date, end_date, instance):
        ...
        try:
            ...
            log_line_obj.create_common_log_line_ec(shopify_instance_id=instance.id,
                                                    message=message,
        ...
        if round(statement_line.amount, 10) == round(move_line_total_amount, 10) and (
            ...
            try:
                if move_line_data:
                    ...
                    self.shopify_reconcile_bank_statement_line_ec(statement_line, move_line_id)
                for payment_line in paid_move_lines:
                    self.shopify_reconcile_bank_statement_line_ec(statement_line, payment_line)
            except Exception as error:
    ...
    def shopify_reconcile_bank_statement_line_ec(self, statement_line_id, move_line_id):
        """
