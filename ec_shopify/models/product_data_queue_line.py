...
class ShopifyProductDataQueueLineEpt(models.Model):
    ...
    def auto_import_product_queue_line_data(self):
        ...
        query = """select queue.id
                ...
                inner join shopify_product_data_queue_ec as queue on queue_line.product_data_queue_id = queue.id
    ...
    def process_product_queue_line_data(self):
        ...
        if queue_id:
            ...
            if shopify_instance.active:
                ...
                self.env.cr.execute(
                    """update shopify_product_data_queue_ec set is_process_queue = False where is_process_queue = True""")
                self._cr.commit()
    ...
    def query_find_queue_line_for_import_image(self):
        query = """select id from shopify_product_data_queue_line_ec
