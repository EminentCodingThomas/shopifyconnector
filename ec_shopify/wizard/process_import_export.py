...
class ShopifyProcessImportExport(models.TransientModel):
    ...
    def shopify_execute(self):
        ...
        if self.shopify_operation == "sync_product":
            ...
            if product_queue_ids:
                ...
                action_name = "ec_shopify.action_shopify_product_data_queue"
                form_view_name = "ec_shopify.product_synced_data_form_view_ec"
            ...
            if customer_queues:
                ...
                action_name = "ec_shopify.action_shopify_synced_customer_data"
                form_view_name = "ec_shopify.shopify_synced_customer_data_form_view_ec"
            ...
            if order_queues:
                ...
                action_name = "ec_shopify.action_shopify_order_data_queue_ec"
                form_view_name = "ec_shopify.view_shopify_order_data_queue_ec_form"
            ...
            if order_queues:
                queue_ids = order_queues
                action_name = "ec_shopify.action_shopify_shipped_order_data_queue_ec"
                form_view_name = "ec_shopify.view_shopify_order_data_queue_ec_form"
            ...
            if exprot_stock_queue_id:
                ...
                action_name = "ec_shopify.action_shopify_export_stock_queue"
                form_view_name = "ec_shopify.export_stock_form_view_ec"
            ...
            if shopify_locations:
                ...
                action_name = "ec_shopify.action_shopify_location_data"
                form_view_name = "ec_shopify.shopify_synced_locations_data_form_view_ec"
    ...
    def update_stock_in_shopify(self, ctx=False):
        ...
        products = product_obj.get_products_based_on_movement_date_ec(last_update_date,
    ...
    def shopify_check_running_schedulers(self, cron_xml_id):
        try:
            cron_id = self.env.ref('ec_shopify.%s%d' % (cron_xml_id, self.shopify_instance_id.id))
        except:
            return
